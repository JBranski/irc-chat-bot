...
export const Home = () => {
	return (
		<main className="Home">
			...
			<p>You may view all currently approved commands under the Commands link, and you may make requests for a command or a channel to be added under the requests tab.</p>
